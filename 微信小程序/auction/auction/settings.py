...
SECRET_KEY = '*@_vq+y)tx%t3f4fpz#5z4y5e9bm!aqs)x$md%i(_+tse%5*bz'
...
EMAIL_PORT = 25
EMAIL_HOST_USER = "alkefu@sina.com" # 你的邮箱账号
EMAIL_HOST_PASSWORD = "38e25a7641b411ae" # 你的邮箱密码
EMAIL_USE_TLS = False # 这里是 False
EMAIL_FROM = "alkefu@sina.com"


# 发送邮件
def send_email(goal_email, code):
    from django.core.mail import send_mail
    email_title = '用户注册'
    email_body = str(code)
    email = goal_email  # 对方的邮箱
